...
- **Description Text**: Downloads the model's description as a text file.
- **Save to Subfolder**: Saves the model into a subfolder. Please note that additional Tampermonkey configuration is required to enable this option.
