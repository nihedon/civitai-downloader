...
ヘッダー部の右側に歯車アイコンが表示され、クリックすると設定画面が表示されます。
設定画面では以下の設定が可能です。

- **Image File Only**: プレビュー画像のみをダウンロードします。
- **Description Text**: モデルの説明文をテキストファイルとしてダウンロードします。
- **Save to Subfolder**: モデルをサブフォルダに保存します。ただし、有効にするにはTamperMonkeyの追加設定が必要になります。
